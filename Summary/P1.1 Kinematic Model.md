...
$$
\begin{align}
\dot X&=F(X_{ref},u_{ref})+\frac{\part F}{\part X}(X-X_{ref})+\frac{\part F}{\part u}(u-u_{ref}) \tag{2} \\
\frac{\part F}{\part X} &=
\begin{bmatrix}
\frac{\part f_1}{\part x_{ref}} & \frac{\part f_1}{\part y_{ref}} & \frac{\part f_1}{\part \psi_{ref}} \\ 
\frac{\part f_2}{\part x_{ref}} & \frac{\part f_2}{\part y_{ref}} & \frac{\part f_2}{\part \psi_{ref}} \\ 
\frac{\part f_3}{\part x_{ref}} & \frac{\part f_3}{\part y_{ref}} & \frac{\part f_3}{\part \psi_{ref}}
\end{bmatrix}=
\begin{bmatrix}
...
\frac{\part F}{\part u} &=
\begin{bmatrix}
\frac{\part f_1}{\part V_{ref}} & \frac{\part f_1}{\part \psi_{ref}} \\
\frac{\part f_2}{\part V_{ref}} & \frac{\part f_2}{\part \psi_{ref}} \\
\frac{\part f_3}{\part V_{ref}} & \frac{\part f_3}{\part \psi_{ref}}
\end{bmatrix}=
\begin{bmatrix}
cos(\psi_{ref}) & 0 \\
sin(\psi_{ref}) & 0 \\
...
X_l = \Delta X \quad u_l = \Delta u& \quad A_l = \frac{\part F}{\part X} \quad B_l = \frac{\part F}{\part u} 
\end{align}
$$
...
$$
\begin{align}
\int_{T}^{T+dt}{\dot X}dt &= \int_{T}^{T+dt}{(AX+Bu)}dt \\
